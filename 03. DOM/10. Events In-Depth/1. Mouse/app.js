...
three.addEventListener("dblclick", () => three.classList.toggle("teal"))
four.addEventListener("mousedown", () => four.classList.toggle("steelblue"))
five.addEventListener("mouseenter", () => five.classList.toggle("orange"))
six.addEventListener("mouseleave", () => six.classList.toggle("purple"))
seven.addEventListener("mousemove", () => seven.classList.toggle("pink"))
eight.addEventListener("mouseout", () => eight.classList.toggle("crimson"))
nine.addEventListener("mouseover", () => nine.classList.toggle("chocolate"))
ten.addEventListener("mouseup", () => ten.classList.toggle("aqua"))